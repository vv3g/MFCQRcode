...
/**
 * 一个简单, 快速的bits数组封装, 内部使用一个int[] 代表bits
 *
 */
public class BitArray implements Cloneable {
	private int[] bits;
	  ...
	  /**
	   *追加最低有效位bits，从最高有效位到最低有效位。例如追加六个bits 0x000001E的顺序为0,1,1,1,1,0
	   *
	   * @param value 需要追加的bits
	   * @param numBits bits 追加到的bits
	   */
